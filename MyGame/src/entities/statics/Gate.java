...
public class Gate extends StaticEntity {
  ...
  public void checkIntersect() {
    ...
    if (/*player.getInventory().getKey() >= 1*/ player.isShooting()) {
      isGateOpened = true;
//            bounds.width = -13;
//            bounds.height = -13;
      super.getBoundsRect()
          .setBounds((int) super.getBoundsRect().getX(), (int) super.getBoundsRect().getY(), -13,
              -13);
    } else {
      isGateOpened = false;
//            bounds.width = 25;
//            bounds.height = 15;
      super.getBoundsRect()
          .setBounds((int) super.getBoundsRect().getX(), (int) super.getBoundsRect().getY(), 25,
              15);
    }
  }
  ...
  public void render(Graphics g) {
    if (isGateOpened) {
      g.drawImage(Assets.getFieldElement("gateOpened"),
      ...
      g.drawImage(Assets.getFieldElement("gateClosed"),
          (int) (super.getX() - super.getHandler().getGameCamera().getxOffset()),
          (int) (super.getY() - super.getHandler().getGameCamera
              ().getyOffset()), super.getWidth(), super.getHeight(), null);
    }
