...
public class Player extends Creature {
  ...
  private static final float PLAYER_RUN_SPEED = 8.0f;
  ...
  private static final float PLAYER_DEFAULT_SPEED = 4.0f;
  ...
  // Animations
  private Animation animLeft, animRight, animUp, animDown, animLeftAttack,
      animRightAttack, animUpAttack, animDownAttack;
  ...
  public Player(Handler handler, float x, float y) {
    ...
    //Animations
    this.animLeft = new Animation(ANIMATION_MOVE_SPEED,
        Assets.getPlayerMotionPositions("player_Left"));
    this.animRight = new Animation(ANIMATION_MOVE_SPEED,
        Assets.getPlayerMotionPositions("player_Right"));
    this.animUp = new Animation(ANIMATION_MOVE_SPEED, Assets.getPlayerMotionPositions("player_Up"));
    this.animDown = new Animation(ANIMATION_MOVE_SPEED,
        Assets.getPlayerMotionPositions("player_Down"));
    this.animLeftAttack = new Animation(ANIMATION_ATTACK_SPEED,
        Assets.getPlayerMotionPositions("player_LeftAttack"));
    this.animRightAttack = new Animation(ANIMATION_ATTACK_SPEED,
        Assets.getPlayerMotionPositions("player_RightAttack"));
    this.animDownAttack = new Animation(ANIMATION_ATTACK_SPEED,
        Assets.getPlayerMotionPositions("player_DownAttack"));
    this.animUpAttack = new Animation(ANIMATION_ATTACK_SPEED,
        Assets.getPlayerMotionPositions("player_UpAttack"));
  ...
  public Player(Handler handler, float x, float y, SaveObject saveObject) {
    ...
    if (this.hasArmor) {
      this.animLeft = new Animation(ANIMATION_MOVE_SPEED,
          Assets.getPlayerMotionPositions("playerArmored_Left"));
      this.animRight = new Animation(ANIMATION_MOVE_SPEED,
          Assets.getPlayerMotionPositions("playerArmored_Right"));
      this.animUp = new Animation(ANIMATION_MOVE_SPEED,
          Assets.getPlayerMotionPositions("playerArmored_Up"));
      this.animDown = new Animation(ANIMATION_MOVE_SPEED,
          Assets.getPlayerMotionPositions("playerArmored_Down"));
      this.animLeftAttack = new Animation(ANIMATION_ATTACK_SPEED,
          Assets.getPlayerMotionPositions("playerArmored_LeftAttack"));
      this.animRightAttack = new Animation(ANIMATION_ATTACK_SPEED,
          Assets.getPlayerMotionPositions("playerArmored_RightAttack"));
      this.animUpAttack = new Animation(ANIMATION_ATTACK_SPEED,
          Assets.getPlayerMotionPositions("playerArmored_UpAttack"));
      this.animDownAttack = new Animation(ANIMATION_ATTACK_SPEED,
          Assets.getPlayerMotionPositions("playerArmored_DownAttack"));
      ...
      this.animRight = new Animation(ANIMATION_MOVE_SPEED,
          Assets.getPlayerMotionPositions("player_Right"));
      this.animUp = new Animation(ANIMATION_MOVE_SPEED,
          Assets.getPlayerMotionPositions("player_Up"));
      this.animDown = new Animation(ANIMATION_MOVE_SPEED,
          Assets.getPlayerMotionPositions("player_Down"));
      this.animLeftAttack = new Animation(ANIMATION_ATTACK_SPEED,
          Assets.getPlayerMotionPositions("player_LeftAttack"));
  ...
  private void updateShoot() {
    double dx =
        this.mouseManager.getMouseX() - (((int) super.getX() + MANA_MOVE_TRACE_DEFLECTION) - super
            .getHandler().getGameCamera().getxOffset());
    double dy =
        this.mouseManager.getMouseY() - (((int) super.getY() + MANA_MOVE_TRACE_DEFLECTION) - super
            .getHandler().getGameCamera().getyOffset());
  ...
  private void checkAttacks() {
    ...
    } else if (super.getHandler().getKeyManager().down && super.getHandler()
        .getKeyManager().attack) {
      attackBounds.x = collisionBounds.x + collisionBounds.width / 2 - ATTACK_RANGE / 2;
      attackBounds.y = collisionBounds.y + collisionBounds.height;
    } else if (super.getHandler().getKeyManager().left && super.getHandler()
        .getKeyManager().attack) {
      attackBounds.x = collisionBounds.x - ATTACK_RANGE;
      attackBounds.y = collisionBounds.y + collisionBounds.height / 2 - ATTACK_RANGE / 2;
    } else if (super.getHandler().getKeyManager().right && super.getHandler()
        .getKeyManager().attack) {
  ...
  public void render(Graphics g) {
    ...
    g.drawImage(getCurrentAnimationFrame(),
        ...
        (int) (super.getY() - super.getHandler().getGameCamera().getyOffset()), super.getWidth(),
...
//                bounds.width, bounds.height);
  ...
  private void drawHealth(Graphics g) {
    g.drawImage(Assets.getFieldElement("playerHealth"), HEART_IMAGE_OFFSET, HEART_IMAGE_OFFSET,
        HEART_IMAGE_SIZE, HEART_IMAGE_SIZE, null);
    g.setColor(Color.red);
    g.fillRect(HEALTH_BAR_OFFSETS[0], HEALTH_BAR_OFFSETS[1], this.getTotalHealth(),
        HEALTH_AND_MANA_BAR_THICKNESS);
    g.setColor(Color.green);
    g.fillRect(HEALTH_BAR_OFFSETS[0], HEALTH_BAR_OFFSETS[1], this.getHealth(),
        HEALTH_AND_MANA_BAR_THICKNESS);
  }
  ...
  private void drawMana(Graphics g) {
    ...
    g.fillRect(MANA_BAR_OFFSETS[0], MANA_BAR_OFFSETS[1], this.getTotalMana(),
        HEALTH_AND_MANA_BAR_THICKNESS);
    g.setColor(Color.blue);
    g.fillRect(MANA_BAR_OFFSETS[0], MANA_BAR_OFFSETS[1], this.getMana(),
        HEALTH_AND_MANA_BAR_THICKNESS);
  }
