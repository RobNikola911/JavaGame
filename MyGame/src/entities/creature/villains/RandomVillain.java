...
public class RandomVillain extends Villain {
  ...
  private void moveVillain() {
    ...
    super
        .setxMove(rand.nextInt(super.getRandomMoveStepGenerationBound()) - super.getDefaultSpeed());
    super
        .setyMove(rand.nextInt(super.getRandomMoveStepGenerationBound()) - super.getDefaultSpeed());
