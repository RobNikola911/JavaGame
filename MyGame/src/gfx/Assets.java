...
public class Assets {
  ...
  //IMAGE PATHS
  private static final String PATH = "./MyGame/resources/GameField/TileSamples-Uncut/sprite.png";
  private static final String HERO_PATH = "./MyGame/resources/Hero/heroechico_swd_AllPositions.png";
  private static final String HERO_ARMOR_PATH = "./MyGame/resources/Hero/WithArmor/ArmoredHero.png";
  private static final String TREES_PATH = "./MyGame/resources/GameField/TileSamples-Uncut/Trees.png";
  private static final String START_SCREEN = "./MyGame/resources/Buttons/StartScreen.png";
  private static final String INFO_TEAM = "./MyGame/resources/Buttons/aboutINFO.png";
  private static final String START_BUTTON = "./MyGame/resources/Buttons/startGame.png";
  private static final String START_BUTTON_HOVERED = "./MyGame/resources/Buttons/startGameRed.png";
  private static final String LOAD_BUTTON = "./MyGame/resources/Buttons/loadGame.png";
  private static final String LOAD_BUTTON_HOVERED = "./MyGame/resources/Buttons/loadGameRed.png";
  private static final String ABOUT_BUTTON = "./MyGame/resources/Buttons/aboutBlack.png";
  private static final String ABOUT_BUTTON_HOVERED = "./MyGame/resources/Buttons/aboutRed.png";
  private static final String QUIT_BUTTON = "./MyGame/resources/Buttons/quitBlack.png";
  private static final String QUIT_BUTTON_HOVERED = "./MyGame/resources/Buttons/quitRed.png";
  private static final String BACK_BUTTON = "./MyGame/resources/Buttons/blackBack.png";
  private static final String BACK_BUTTON_HOVERED = "./MyGame/resources/Buttons/backRed.png";
  private static final String VILLAIN_PATH = "./MyGame/resources/Monster/Monster_uncut.png";
  private static final String CHASER_VILLAIN_PATH = "./MyGame/resources/Monster/Monster_uncut_Chaser.png";
  private static final String END_GAME = "./MyGame/resources/game-over-png-20.png";
  private static final String PlAYER_HEALTH = "./MyGame/resources/Hero/heart.png";
  private static final String INVENTORY = "./MyGame/resources/GameField/inventory.png";
  private static final String COIN = "./MyGame/resources/GameField/coin.png";
  private static final String STONE1 = "./MyGame/resources/GameField/stone1.png";
  private static final String ROCKITEM = "./MyGame/resources/GameField/rockItem.png";
  private static final String MEAT = "./MyGame/resources/GameField/meat.png";
  private static final String SHEEP = "./MyGame/resources/Sheep/sheep_walk.png";
  private static final String CHEST = "./MyGame/resources/GameField/chest.png";//AY
  private static final String KEY = "./MyGame/resources/GameField/key.png";//AY
  private static final String GATE_CLOSED = "./MyGame/resources/GameField/gate/gateClosed.png";//AY
  private static final String GATE_OPENED = "./MyGame/resources/GameField/gate/gateOpened.png";//AY
  //iceland
  private static final String SNOW = "./MyGame/resources/GameField/iceland/snow.png";//AY
  private static final String SNOWY_TREE = "./MyGame/resources/GameField/iceland/SnowyTree.png";//AY
  private static final String SNOWY_BUSH = "./MyGame/resources/GameField/iceland/SnowyBush.png";//AY
  //desert
  private static final String SAND = "./MyGame/resources/GameField/desert/sand.png";//AY
  private static final String CACTUS1 = "./MyGame/resources/GameField/desert/cactus1.png";//AY
  private static final String CACTUS2 = "./MyGame/resources/GameField/desert/cactus2.png";//AY
  private static final String PALMTREE = "./MyGame/resources/GameField/desert/palmtree.png";//AY
  private static final String MAGIC = "./MyGame/resources/Magic/magic.png";
  private static final String SOUND = "./MyGame/resources/SoundButtons/sound.png";
  private static final String SOUND_MUTE = "./MyGame/resources/SoundButtons/sound_mute.png";
  ...
  public static void init() {
    ...
    //Villains
    entitiesMotionPositions.put("villain_Left",
        new BufferedImage[]{villains.crop(7, 64, 59, 64), villains.crop(134, 64, 59, 64)});
    entitiesMotionPositions.put("villain_Right",
        new BufferedImage[]{villains.crop(7, 128, 59, 64), villains.crop(134, 128, 59, 64)});
    entitiesMotionPositions.put("villain_Up",
        new BufferedImage[]{villains.crop(4, 193, 59, 64), villains.crop(132, 193, 59, 64)});
    entitiesMotionPositions.put("villain_Down",
        new BufferedImage[]{villains.crop(4, 0, 59, 64), villains.crop(132, 0, 59, 64)});
    entitiesMotionPositions.put("chaserVillain_Left",
        new BufferedImage[]{chaserVillains.crop(7, 64, 59, 64),
            chaserVillains.crop(134, 64, 59, 64)});
    entitiesMotionPositions.put("chaserVillain_Right",
        new BufferedImage[]{chaserVillains.crop(7, 128, 59, 64),
            chaserVillains.crop(134, 128, 59, 64)});
    entitiesMotionPositions.put("chaserVillain_Up",
        new BufferedImage[]{chaserVillains.crop(4, 193, 59, 64),
            chaserVillains.crop(132, 193, 59, 64)});
    entitiesMotionPositions.put("chaserVillain_Down",
        new BufferedImage[]{chaserVillains.crop(4, 0, 59, 64),
            chaserVillains.crop(132, 0, 59, 64)});

    //Sheep
    entitiesMotionPositions.put("sheep_Left",
        new BufferedImage[]{sheep.crop(0, 57, 60, 57), sheep.crop(120, 57, 60, 57)});
    entitiesMotionPositions.put("sheep_Right",
        new BufferedImage[]{sheep.crop(0, 171, 60, 57), sheep.crop(120, 171, 60, 57)});
    entitiesMotionPositions
        .put("sheep_Up", new BufferedImage[]{sheep.crop(0, 0, 60, 57), sheep.crop(120, 0, 60, 57)});
    entitiesMotionPositions.put("sheep_Down",
        new BufferedImage[]{sheep.crop(0, 114, 60, 57), sheep.crop(120, 114, 60, 57)});
    ...
    playerMotionPositions.put("player_Left",
        new BufferedImage[]{playerSheet.crop(28, 144, 45, 55), playerSheet.crop(222, 150, 45, 50)});
    playerMotionPositions.put("player_Right",
        new BufferedImage[]{playerSheet.crop(20, 245, 45, 55), playerSheet.crop(229, 252, 45, 50)});
    playerMotionPositions.put("player_Up",
        new BufferedImage[]{playerSheet.crop(26, 350, 45, 49), playerSheet.crop(116, 348, 50, 49)});
    playerMotionPositions.put("player_Down",
        new BufferedImage[]{playerSheet.crop(120, 50, 45, 50), playerSheet.crop(211, 50, 50, 50)});
    playerMotionPositions.put("player_LeftAttack",
        new BufferedImage[]{playerSheet.crop(28, 144, 45, 55), playerSheet.crop(222, 150, 45, 50),
            playerSheet.crop(320, 150, 45, 50)});
    playerMotionPositions.put("player_RightAttack",
        new BufferedImage[]{playerSheet.crop(20, 245, 45, 55), playerSheet.crop(229, 252, 45, 50),
            playerSheet.crop(335, 252, 45, 50)});
    playerMotionPositions.put("player_UpAttack",
        new BufferedImage[]{playerSheet.crop(315, 350, 65, 50), playerSheet.crop(225, 350, 65, 50),
            playerSheet.crop(115, 348, 70, 50)});
    playerMotionPositions.put("player_DownAttack",
        new BufferedImage[]{playerSheet.crop(211, 50, 50, 50), playerSheet.crop(120, 50, 45, 50),
            playerSheet.crop(20, 50, 45, 50)});

    //Player motion positions - armored
    playerMotionPositions.put("playerArmored_Left",
        new BufferedImage[]{playerArmoredSheet.crop(7, 98, 35, 35),
            playerArmoredSheet.crop(104, 98, 35, 35)});
    playerMotionPositions.put("playerArmored_Right",
        new BufferedImage[]{playerArmoredSheet.crop(4, 147, 35, 35),
            playerArmoredSheet.crop(100, 147, 35, 35)});
    playerMotionPositions.put("playerArmored_Up",
        new BufferedImage[]{playerArmoredSheet.crop(7, 52, 35, 35),
            playerArmoredSheet.crop(102, 52, 35, 35)});
    playerMotionPositions.put("playerArmored_Down",
        new BufferedImage[]{playerArmoredSheet.crop(7, 4, 35, 35),
            playerArmoredSheet.crop(102, 4, 35, 35)});
    playerMotionPositions.put("playerArmored_LeftAttack",
        new BufferedImage[]{playerArmoredSheet.crop(291, 98, 35, 35),
            playerArmoredSheet.crop(237, 98, 38, 35), playerArmoredSheet.crop(196, 98, 35, 35)});
    playerMotionPositions.put("playerArmored_RightAttack",
        new BufferedImage[]{playerArmoredSheet.crop(297, 148, 35, 35),
            playerArmoredSheet.crop(254, 148, 35, 35), playerArmoredSheet.crop(200, 148, 35, 35)});
    playerMotionPositions.put("playerArmored_UpAttack",
        new BufferedImage[]{playerArmoredSheet.crop(295, 46, 35, 40),
            playerArmoredSheet.crop(246, 46, 35, 40), playerArmoredSheet.crop(195, 46, 35, 40)});
    playerMotionPositions.put("playerArmored_DownAttack",
        new BufferedImage[]{playerArmoredSheet.crop(336, 0, 35, 40),
            playerArmoredSheet.crop(287, 0, 35, 40), playerArmoredSheet.crop(248, 0, 35, 40)});

    //Menu elements
    menuElements.put("btn_start",
        new BufferedImage[]{buttonNormal.crop(0, 0, 412, 107), buttonHovered.crop(0, 0, 412, 107)});
    menuElements.put("btn_load", new BufferedImage[]{buttonLoadNormal.crop(0, 0, 412, 107),
        buttonLoadHovered.crop(0, 0, 412, 107)});
    menuElements.put("btn_about", new BufferedImage[]{buttonAboutNormal.crop(0, 0, 231, 91),
        buttonAboutHovered.crop(0, 0, 231, 91)});
    menuElements.put("btn_quit", new BufferedImage[]{buttonQuitNormal.crop(0, 0, 159, 107),
        buttonQuitHovered.crop(0, 0, 159, 107)});
    menuElements.put("btn_back", new BufferedImage[]{buttonBackNormal.crop(0, 0, 198, 91),
        buttonBackHovered.crop(0, 0, 198, 91)});
    ...
    menuElements.put("sound",
        new BufferedImage[]{soundSheet.crop(0, 0, 26, 26), soundMuteSheet.crop(0, 0, 26, 26)});
    menuElements.put("soundAlt",
        new BufferedImage[]{soundSheet.crop(0, 0, 26, 26), soundMuteSheet.crop(0, 0, 26, 26)});

    //ALL GAME FIELD TILES AND ELEMENTS
    gameFieldElements
        .put("grass", sheet.crop(3 * TILE_WIDTH, 2 * TILE_HEIGHT, TILE_WIDTH, TILE_HEIGHT));
    ...
    gameFieldElements
        .put("stone_wall_up1", sheet.crop(438, 505 - TILE_HEIGHT, TILE_WIDTH, TILE_HEIGHT));
    gameFieldElements.put("stone_wall_up2",
        sheet.crop(435 + TILE_WIDTH, 505 - TILE_HEIGHT, TILE_WIDTH, TILE_HEIGHT));
    gameFieldElements.put("stone_wall_down1", sheet.crop(445, 450, TILE_WIDTH, TILE_HEIGHT));
    gameFieldElements
        .put("stone_wall_down2", sheet.crop(445 + TILE_WIDTH, 450, TILE_WIDTH, TILE_HEIGHT));
    gameFieldElements
        .put("stone_wall_left", sheet.crop(510 - TILE_WIDTH, 398, TILE_WIDTH - 5, TILE_HEIGHT - 5));
    gameFieldElements
        .put("stone_wall_right", sheet.crop(500, 400, TILE_WIDTH - 5, TILE_HEIGHT - 5));
