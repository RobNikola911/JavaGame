...
public class GameCamera {
  ...
  public void checkBlankSpace() {
    ...
    } else if (this.xOffset
        > this.handler.getWorld().getWidth() * Tile.getTileWidth() - this.handler.getWidth()) {
      this.xOffset =
          this.handler.getWorld().getWidth() * Tile.getTileWidth() - this.handler.getWidth();
    }
    if (this.yOffset < 0) {
      this.yOffset = 0;
        ...
        > this.handler.getWorld().getHeight() * Tile.getTileHeight() - this.handler.getHeight()) {
      this.yOffset =
          this.handler.getWorld().getHeight() * Tile.getTileHeight() - this.handler.getHeight();
    }
